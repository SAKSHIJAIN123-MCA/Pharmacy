...
export default function HealthArticlesPage() {
  return (
    <div className="p-4 sm:p-6 max-w-8xl mx-auto">
      <div className="bg-blue-600 text-white text-center py-8 sm:py-12 mb-8 px-2 sm:px-0">
        <h1 className="text-2xl sm:text-3xl font-semibold leading-snug">
          Stay informed with carefully curated articles, expert insights, and the latest research on topics.
        </h1>
      </div>
