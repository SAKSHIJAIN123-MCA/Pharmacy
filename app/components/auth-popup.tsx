...
// Validation schema for signup (extends login)
...
export const AuthPopup = ({ onClose }: AuthPopupProps) => {
  ...
  // Setup form with dynamic schema resolver based on mode
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      if (isSignUp) {
        // Signup flow: call your backend API to register
        ...
        // Login flow using next-auth signIn
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                {!isSignUp && (
                  <div className="text-right">
                    <Link href="/forgot-password" className="text-sm text-gray-500 hover:text-teal-900">
                      Forgot Password?
                    </Link>
                  </div>
                )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center gap-2">
                        <FormControl>
                          <Checkbox checked={field.value} onCheckedChange={field.onChange} id="acceptTerms" />
                        </FormControl>
