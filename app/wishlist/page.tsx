...
import UserAccountSidebar from "@/app/components/user-account-sidebar";
                        ...
                        <div className="flex-1 flex flex-col gap-4 justify-between">
                          <div>
                            <div className="flex flex-row  sm:flex-row sm:justify-between items-start sm:items-center gap-8">
                              <Link
                                href={`/products/${item.product.slug}`}
                                className="text-xl sm:text-2xl font-medium text-blue-600"
                              >
                                {item.product.name}
                              </Link>
                              <button
                                onClick={() => removeFromWishlist(item._id)}
                                className="self-start sm:self-auto text-gray-700 hover:bg-blue-600 p-2 rounded-full hover:text-white transition-colors duration-200"
                          ...
                          <div className=" mb-60">
                            <Button
                              className="w-full sm:w-auto border bg-blue-600 hover:bg-blue-600 text-white"
                              onClick={() =>
