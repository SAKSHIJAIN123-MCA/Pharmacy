          ...
          <div className="flex-1">
            <div className="bg-white p-6 rounded-md shadow-sm">
              <div className="flex justify-between items-center mb-6">
                ...
                <Button className="bg-blue-700 hover:bg-blue-800 text-white" onClick={handleAddAddress}>
              ...
              {addresses.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {addresses.map((address) => (
                    <div
                      key={address._id}
                      className={`border rounded-md p-4 ${address.is_default ? "border-blue-700 bg-blue-50" : ""}`}
                    >
                      {address.is_default && (
                        <div className="mb-2">
                          <span className="bg-blue-700 text-white text-xs px-2 py-1 rounded">Default</span>
                        </div>
                      )}
